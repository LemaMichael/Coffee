...
class ViewController: UITableViewController {
    ...
    lazy var footerView: FooterView = {
        let footerView =  FooterView(frame: CGRect(x: 0, y: 0, width: view.frame.width, height: view.frame.height * 0.6))
        return footerView
    }()
    ...
    fileprivate func setupDateLabels() {
        ...
        // Pattern Matching ~= 
        UserDefaults.standard.setDarkMode(value: (6..<19 ~= hour) ? false : true)
